...
Проверяет реальные локальные диски и отправляет уведомление в ntfy, если на каком-то из них осталось меньше заданного процента свободного места. По умолчанию порог — 10%, уведомления отправляются только с 10:00 по 20:00 по локальному времени машины.
